function  EOS_source(dataset_name)
...
vector_S_source = 2 .^ [-10:10];

for iter = 1 : length(vector_S_source)
	options.sigma = vector_S_source(iter);
...
stat_file = sprintf('../../stat/eos_source/%d/%d-hom-stat', iter, dataset_name);
