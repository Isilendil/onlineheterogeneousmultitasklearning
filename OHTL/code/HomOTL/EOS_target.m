function  EOS_target(dataset_name)
...
vector_S_target = 2 .^ [-10:10];

for iter = 1 : length(vector_S_target)
	options.sigma2 = vector_S_target(iter);
...
stat_file = sprintf('../../stat/eos_target/%d/%d-hom-stat', iter, dataset_name);
