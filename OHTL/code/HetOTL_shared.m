function [classifier_1, err_count_1, run_time, mistakes_1, mistakes_idx, SVs, TMs] = HetOTL_shared(Kernel_1, Y_1, c_1_1, Kernel_2, Y_2, c_2_2, options, id_list)
% HetOTL: HetOTL
%--------------------------------------------------------------------------
% Input:
...
classifier_1.SV2 = SV2;
classifier_1.alpha1 = alpha1;
classifier_1.alpha2 = alpha2;
