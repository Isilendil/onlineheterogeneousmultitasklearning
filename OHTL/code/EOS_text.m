...
vector_S_text = 2 .^ [-10:10];

for iter = 1 : length(vector_S_text)
	options.sigma_text = vector_S_text(iter);
...
stat_file = sprintf('../stat/eos_text/%d/%d-stat', iter, data_file);
