...
function error_final_all_task_hist(directory)
...
mean_error_final = [mean_error_final, mean_error_final_vector_PA_SL'];
...
grid;
saveas(gcf, sprintf('../process_result/%s/%d/error_final_all_task_hist.fig', directory, iter));
saveas(gcf, sprintf('../process_result/%s/%d/error_final_all_task_hist.eps', directory, iter));
saveas(gcf, sprintf('../process_result/%s/%d/error_final_all_task_hist.pdf', directory, iter));
close(figure(gcf));
%========================================================
