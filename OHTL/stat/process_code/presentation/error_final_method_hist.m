...
function error_final_method_hist()
...
grid;
saveas(gcf, './figure/error_final_method_hist.fig');
saveas(gcf, './figure/error_final_method_hist.eps');
saveas(gcf, './figure/error_final_method_hist.pdf');
