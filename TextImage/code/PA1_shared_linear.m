function [classifier_1, err_count_1, mistakes_1, classifier_2, err_count_2, mistakes_2, run_time] = PA1_shared_linear(X_1, Y_1, X_2, Y_2, options, id_list)
...
for t = 1:length(ID),
    ...
    if (l_t_1>0)
        ...
        tau_t_1 = l_t_1/(s_t_1 + theta);
				v_1 = v_1 + tau_t_1 * y_t_1 * x_t_1;
    end
    if (l_t_2>0)
        % update
        s_t_2 = x_t_2 * x_t_2';
        tau_t_2 = l_t_2/(s_t_2 + theta);
				v_2 = v_2 + tau_t_2 * y_t_2 * x_t_2;
    end
