function [classifier_1, err_count_1, mistakes_1, classifier_2, err_count_2, mistakes_2, run_time] = PA1_extra_sim_self(Kernel_1, Y_1, c_1_1, Kernel_2, Y_2, c_2_2, options, id_list)
      ...
      if (isempty(alpha_1))
		...
		for i = 1 : K
		  if (isempty(alpha_2))
		    ...
		    k_t_2_2 = Kernel_2(index(i), SV_2(:))';
        f_t_2_2 = alpha_2 * k_t_2_2;
		  end
		  l_t_2_2 = max(0, 1 - y_t_2*f_t_2_2);
		  l_t_2_2 = min(l_t_2_2, 1);
		  if (l_t_2_2 > 0)
			  %s_t_1_2 = Kernel_2(index(i), index(i));
			  %tau_t_1_2 = 0.5 * min(C, l_t_1_2/s_t_1_2);
			  %tau_t_1_2 = sim(i) * l_t_1_2/(s_t_1_2+1/(2*C));
			  tau_t_2_2 = sim(i);
			  alpha_2 = [alpha_2 y_t_2*tau_t_2_2];
			  SV_2 = [SV_2 index(i)];
		  end
		end
