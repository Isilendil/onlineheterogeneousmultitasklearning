function [classifier, err_count, run_time, mistakes, mistakes_idx, SVs, TMs] = avePA1_het_s(Y, K, options, id_list)
% PA1: Average online passive-aggressive algorithm I
%--------------------------------------------------------------------------
% Input:
