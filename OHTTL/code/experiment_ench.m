...
%load('../../EnglishChinese/data/feature_HTLIC/en-ch');
...
load('../../EnglishChinese/data/feature_het/en-ch');
X_het = CH_fea_het;
...
%load('../../EnglishChinese/data/feature_PCA/en-ch');
%X_pca = feature_pca;
...
stat_file = '../stat/englishchinese/ench';
save(stat_file, 'nSV_pa', 'err_pa', 'time_pa', 'mistakes_list_pa', 'SVs_pa', 'TMs_pa', 'nSV_het', 'err_het', 'time_het', 'mistakes_list_het', 'SVs_het', 'TMs_het', 'nSV_OTL_knn', 'err_OTL_knn', 'time_OTL_knn', 'mistakes_list_OTL_knn', 'SVs_OTL_knn', 'TMs_OTL_knn', 'nSV_OTL2_knn', 'err_OTL2_knn', 'time_OTL2_knn', 'mistakes_list_OTL2_knn', 'SVs_OTL2_knn', 'TMs_OTL2_knn', 'nSV_OTL_pa', 'err_OTL_pa', 'time_OTL_pa', 'mistakes_list_OTL_pa', 'SVs_OTL_pa', 'TMs_OTL_pa', 'nSV_OTL2_pa', 'err_OTL2_pa', 'time_OTL2_pa', 'mistakes_list_OTL2_pa', 'SVs_OTL2_pa', 'TMs_OTL2_pa');
